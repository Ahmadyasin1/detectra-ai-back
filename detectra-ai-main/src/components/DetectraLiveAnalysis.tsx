        ...
        try {
          ...
          if (msg.type === 'completed' || msg.status === 'completed') {
            ...
            try {
              ...
              setError(`Analysis done but could not load results: ${e.message}`);
            } finally {
              setRunning(false);
            }
          }
                  ...
                  <div
                    ...
                    className={`border-2 border-dashed rounded-2xl p-8 text-center cursor-pointer transition-all duration-200 ${
                      dragging
                        ...
                        : 'border-gray-700 bg-gray-900 hover:border-cyan-500/50 hover:bg-gray-800/60'
                    }`}
                  >
                        ...
                        return (
                          <div key={st.key} className={`flex items-center gap-2.5 px-3 py-2 rounded-lg transition-colors ${
                            ...
                            <div className={`w-6 h-6 rounded-lg flex items-center justify-center flex-shrink-0 ${
                              done ? 'bg-green-500/20' : active ? 'bg-cyan-500/20' : 'bg-gray-800'
                            }`}>
                              {done
