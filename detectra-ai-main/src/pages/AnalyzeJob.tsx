...
function InfoChip({ icon: Icon, label, value, color }: {
  ...
  return (
    <div className="flex items-center gap-2 px-3.5 py-2 bg-gray-800/60 rounded-xl border border-gray-700">
          ...
          <div className="space-y-5">
                  ...
                  return (
                    <motion.div
                      ...
                      className={`flex items-center gap-3 p-3 rounded-xl transition-all duration-300 ${
                        active ? 'bg-gray-800/80 border border-gray-700'
                        : done  ? 'bg-gray-900/60'
                        : 'bg-gray-900/30'
                      }`}
                    >
            ...
            {log.length > 0 && (
              <motion.div
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
                className="bg-gray-950 rounded-2xl border border-gray-800 p-4"
              >
