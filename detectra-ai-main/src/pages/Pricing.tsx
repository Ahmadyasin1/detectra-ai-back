...
const COMPARE_ROWS: { label: string; free: string; pro: string; ent: string; icon?: React.FC<any> }[] = [
...
function FAQItem({ q, a }: { q: string; a: string }) {
  ...
  return (
    <div className="border border-gray-800 rounded-xl overflow-hidden">
      <button
        onClick={() => setOpen(o => !o)}
        className="w-full flex items-center justify-between gap-4 px-5 py-4 text-left hover:bg-gray-900/50 transition-colors"
      >
      ...
      {open && (
        <motion.div
          ...
          className="px-5 pb-4 text-gray-500 text-sm leading-relaxed border-t border-gray-800 pt-3"
        >
          {a}
        </motion.div>
      )}
...
export default function Pricing() {
  ...
  return (
    <div className="min-h-screen bg-gray-950 pt-20">
      ...
      <section className="py-12 sm:py-16 bg-gray-900/40">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="card-dark overflow-hidden">
            {/* Table header */}
            <div className="grid grid-cols-4 border-b border-gray-800 bg-gray-900/60">
            ...
            {COMPARE_ROWS.map(({ label, free, pro, ent, icon: Icon }, i) => {
              ...
              return (
                <div key={label} className={`grid grid-cols-4 border-b border-gray-800 last:border-0 ${i % 2 === 0 ? '' : 'bg-gray-900/20'}`}>
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              ...
              <Link to="/demo">
                <motion.div
                  whileHover={{ scale: 1.02 }}
                  whileTap={{ scale: 0.98 }}
                  className="flex items-center gap-2 px-8 py-3.5 bg-gray-900 border border-gray-700 text-gray-300 rounded-xl font-semibold hover:bg-gray-800 hover:text-white transition-all"
                >
                  View Live Demo
                </motion.div>
              </Link>
