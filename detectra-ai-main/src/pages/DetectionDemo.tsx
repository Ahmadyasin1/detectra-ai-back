...
export default function DetectionDemo() {
  ...
  return (
    <div className="min-h-screen bg-gray-950">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 text-left">
              {MODELS.map((m, i) => (
                <motion.div
                  ...
                  className={`group relative bg-gray-900 rounded-xl p-5 border ${m.border} transition-all duration-200 hover:-translate-y-0.5`}
                >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-gray-500 text-base max-w-xl mx-auto">
              Connect to a running <code className="px-1.5 py-0.5 bg-gray-800 text-gray-300 rounded text-sm">api_server.py</code> instance
      ...
      {/* ── Footer CTA ── */}
      <section className="py-20 bg-gradient-to-b from-gray-950 via-gray-900/50 to-gray-950 border-t border-gray-800/50">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              ...
              <Link to="/fyp-project">
                <motion.div
                  ...
                  whileTap={{ scale: 0.98 }}
                  className="inline-flex items-center gap-2 px-8 py-3.5 bg-transparent border border-gray-700 text-gray-400 rounded-xl font-semibold hover:border-gray-600 hover:text-white transition-all"
                >
                  View Full Project
                </motion.div>
              </Link>
