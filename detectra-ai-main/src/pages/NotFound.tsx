        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
          ...
          <button onClick={() => window.history.back()}>
            <motion.div
              ...
              whileTap={{ scale: 0.98 }}
              className="flex items-center gap-2 px-6 py-3 bg-gray-800 border border-gray-700 text-gray-300 rounded-xl font-semibold text-sm hover:bg-gray-700 hover:text-white hover:border-gray-600 transition-all"
            >
