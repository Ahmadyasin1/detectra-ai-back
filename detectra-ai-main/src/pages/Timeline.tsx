...
export default function Timeline() {
  ...
  return (
    <div className="pt-20 min-h-screen bg-gray-950">
      ...
      {/* Metrics strip */}
      <section ref={metricsRef} className="py-10 bg-gray-900 border-y border-gray-800">
            ...
            <div className="space-y-6">
              {PHASES.map((phase, i) => (
                ...
                >
                  ...
                  {/* Card */}
                  <div className={`card-dark p-5 transition-all duration-300 ${
                    ...
                    {phase.achievement && phase.status !== 'planned' && (
                      <div className="mt-3 flex items-center gap-2 text-xs text-gray-500 border-t border-gray-800 pt-3">
