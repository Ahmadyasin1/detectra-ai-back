...
from detectra_cv2 import cv2  # headless-safe; fails fast with clear message on Heroku
import numpy as np
...
# api_server sets OUTPUT_DIR env (e.g. /tmp/detectra/analysis_output on Heroku)
